...
<head>
    ...
    <title>Despachador Online</title>
...
<body>
    ...
    <div id="index-banner" class="parallax-container">
        <div class="section no-pad-bot">
            <div class="container">
                <br><br>
                <h1 class="header center teal-text text-lighten-2">Nombre sitio</h1>
                <div class="row center">
                    <h5 class="header col s12 light">Una moderna e inteligente forma de trasladarse por la ciudad.</h5>
                </div>
                <div class="row center">
